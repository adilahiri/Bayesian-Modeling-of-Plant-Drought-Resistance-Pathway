...
barplot(t(c2),ylim =c(0,200),ylab="count",col=c("black","red"),cex.names=1.6,cex.axis=1.6)
#title(main="Activation vs Inhibition",cex.main=4.0)
legend("topleft",c("Activated","Inhibited"),fill=c("red","black"),cex=2.0)
