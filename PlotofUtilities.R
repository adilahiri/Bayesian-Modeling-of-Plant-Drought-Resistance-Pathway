...
x<-barplot(A, beside=T, col=c("red","black"), ylab="Utility",
                 names.arg=name1, ylim=c(0,80),cex.names=1.8,cex.axis=1.8)
#title(main="MEU Plot using Bayesian Parameters",cex.main=4.0)
...
y<-barplot(B, beside=T, col=c("red","black"), ylab="Utility",
        names.arg=name1, ylim=c(0,80),cex.names=1.8,cex.axis=1.8)
#title(main="MEU Plot using MLE Parameters",cex.main=4.0)
